...
description: Deploying oidc-exchange on a Linux host with any supported backend
version: "0.2"
...
- [Linux + PostgreSQL](linux-postgres.md) — relational storage with optional Valkey for sessions
- [Linux + SQLite](linux-sqlite.md) — embedded storage for single-server deployments
