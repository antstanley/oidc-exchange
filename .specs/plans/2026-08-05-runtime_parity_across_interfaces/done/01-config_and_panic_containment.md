...
**Evidence (2026-08-23):** focused nextest runs: config 28 passed / 0 failed / 113 skipped; base path 14 passed / 0 failed / 91 skipped; panic containment 3 passed / 0 failed / 102 skipped. `cargo fmt --all --check` passed; `cargo clippy --workspace -- -D warnings` passed; `cargo nextest run --workspace --no-fail-fast` passed 399 / failed 0 / skipped 27. F3 follow-up additionally proves the outer FFI future guard contains both a router service-future poll panic and a response-body `poll_frame` panic through complete collection, returning only the generic 500 contract.
