...
**Status:** Done · **Layout:** kanban · **Date:** 2026-07-02 · **Owner:** Ant Stanley · **Source spec:** [.specs/changes/merged/2026-07-01-wire_audit_event_emission.md](../../changes/merged/2026-07-01-wire_audit_event_emission.md)
...
- **Spec.** Change spec [.specs/changes/merged/2026-07-01-wire_audit_event_emission.md](../../changes/merged/2026-07-01-wire_audit_event_emission.md). In scope: the `[audit]` configuration and `emit_audit` filter ([06-configuration](../../service/specs/06-configuration.md), [07-telemetry-and-audit](../../service/specs/07-telemetry-and-audit.md)); the session client-context population ([01-domain-model](../../service/specs/01-domain-model.md) §Session); the audit emission points across the flows ([03-service-flows](../../service/specs/03-service-flows.md)); and the handler consumption of `AuditContext` ([04-http-api](../../service/specs/04-http-api.md) §Middleware stack).
