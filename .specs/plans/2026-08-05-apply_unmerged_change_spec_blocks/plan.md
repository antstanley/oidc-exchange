...
**Status:** Backlog · **Layout:** kanban · **Date:** 2026-08-05 · **Owner:** Ant Stanley · **Source change:** `spec/apply-unmerged-change-spec-blocks` / PR #29
...
- **Certificate omission.** Intentional: no `done/` directory or done certificates are created because this is a planning backlog, not execution evidence.
...
|---|---|---|---|---|
| 01 · configuration_and_ffi | Backlog | — | — | Complete-config-loading blocks on `01-ffi-core.md`, `04-http-api.md`, and `06-configuration.md` |
| 02 · lifecycle_and_admin_canonical_pages | Backlog | — | — | Lifecycle-transition blocks on `01-domain-model.md`, `03-service-flows.md`, and `04-http-api.md` |
| 03 · audit_and_lambda_http_canonical_pages | Backlog | — | — | Audit-emission blocks on `01-domain-model.md`, `03-service-flows.md`, `04-http-api.md`, `06-configuration.md`, `07-telemetry-and-audit.md`, plus Lambda blocks on `04-http-api.md` and `06-configuration.md` |
| 04 · final_scope_and_link_audit | Backlog | 01, 02, 03 | review | One PR-level verification that all source blocks, dates, scope limits, task links, status, and DAG are correct |
...
- The canonical pages remain **Implemented**; this plan and its task packages remain **Backlog** until an executor moves them through the kanban.
