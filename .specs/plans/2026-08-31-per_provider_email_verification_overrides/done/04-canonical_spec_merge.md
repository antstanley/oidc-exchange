...
**Implements:** change spec [§Affected spec pages, §Proposed changes (all nine blocks), §Type changes, and §Merge plan](../../../changes/merged/2026-08-31-per_provider_email_verification_overrides.md)
