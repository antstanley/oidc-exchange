...
**Status:** Done · **Layout:** kanban · **Date:** 2026-07-02 · **Owner:** Ant Stanley · **Source spec:** [.specs/changes/merged/2026-07-01-fix_kms_ecdsa_and_jwk_encoding.md](../../changes/merged/2026-07-01-fix_kms_ecdsa_and_jwk_encoding.md)
...
- **Spec.** Change spec [.specs/changes/merged/2026-07-01-fix_kms_ecdsa_and_jwk_encoding.md](../../changes/merged/2026-07-01-fix_kms_ecdsa_and_jwk_encoding.md); it targets one canonical page, [.specs/service/specs/02-ports-and-adapters.md](../../service/specs/02-ports-and-adapters.md) (KeyManager trait note and the KMS row of the Adapter inventory). All implementation notes point at `crates/adapters/src/kms/mod.rs` and `crates/adapters/Cargo.toml`.
