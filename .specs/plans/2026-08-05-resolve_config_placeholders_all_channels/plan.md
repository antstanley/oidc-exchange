...
**Status:** Review · **Layout:** kanban · **Date:** 2026-08-05 · **Owner:** Ant Stanley · **Source spec:** [`.specs/changes/2026-08-05-resolve_config_placeholders_all_channels.md`](../../changes/2026-08-05-resolve_config_placeholders_all_channels.md)
...
- **Done certificates.** Intentionally omitted by explicit instruction. This plan creates no `done/` directory and no `*-certificate.md` files; task checklists, review evidence, and the plan-level DoDs are the sole tracking artifacts.
