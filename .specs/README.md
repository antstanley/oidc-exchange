...
| [changes/2026-08-05-verify_admin_ui_session_jwt.md](changes/2026-08-05-verify_admin_ui_session_jwt.md) | Proposed | admin-ui: verify the session JWT against the service JWKS, fail closed, harden the cookie |
| [changes/2026-08-05-validate_revoke_token_claims.md](changes/2026-08-05-validate_revoke_token_claims.md) | Proposed | service: full claim validation on `/revoke`, `sid` claim binding revocation to one session |
| [changes/2026-08-05-bind_id_token_grant_replay_protection.md](changes/2026-08-05-bind_id_token_grant_replay_protection.md) | Proposed | service: server-issued nonce, `azp`/`at_hash`, single-use assertions, `[grants] id_token` switch |
| [changes/2026-08-05-bind_grant_type_at_token_endpoint.md](changes/2026-08-05-bind_grant_type_at_token_endpoint.md) | Proposed | service: `grant_type` selects the flow, `ExchangeCredential` enum, closed per-grant parameter sets |
| [changes/2026-08-05-rotate_refresh_tokens_with_reuse_detection.md](changes/2026-08-05-rotate_refresh_tokens_with_reuse_detection.md) | Proposed | service: atomic refresh rotation, reuse detection, SR1–SR5 session-port conformance suite |
| [changes/2026-08-05-resolve_config_placeholders_all_channels.md](changes/2026-08-05-resolve_config_placeholders_all_channels.md) | Proposed | service, bindings: one `resolve()` on every config entry point, `config check` subcommand |
| [changes/2026-08-05-audit_and_throttle_authentication_failures.md](changes/2026-08-05-audit_and_throttle_authentication_failures.md) | Proposed | service: mandatory `SecurityEvent` channel, durable audit, `RateLimiter` port on public routes |
| [changes/2026-08-05-fail_closed_across_config_and_adapters.md](changes/2026-08-05-fail_closed_across_config_and_adapters.md) | Proposed | repo-wide: fail-closed principle, seven fail-open sites, closed-domain config types |
| [changes/2026-08-05-harden_admin_plane.md](changes/2026-08-05-harden_admin_plane.md) | Proposed | service, admin-ui: named operator principal, separate admin listener, bounded admin queries |
| [changes/2026-08-05-runtime_parity_across_interfaces.md](changes/2026-08-05-runtime_parity_across_interfaces.md) | Proposed | service, bindings: one owned request normaliser, async total FFI, differential conformance corpus |
| [changes/2026-08-05-eliminate_secret_leakage_in_logs_and_spans.md](changes/2026-08-05-eliminate_secret_leakage_in_logs_and_spans.md) | Proposed | service: `Secret<T>` newtype, bounded upstream bodies, split client/operator error surface, bounded request id |
| [changes/2026-08-05-harden_release_supply_chain.md](changes/2026-08-05-harden_release_supply_chain.md) | Proposed | distribution: per-job least privilege, pinned publish tooling, frozen lockfiles, build attestation, three-graph advisory gate |
| [changes/2026-08-05-own_outbound_http_boundary.md](changes/2026-08-05-own_outbound_http_boundary.md) | Proposed | service: shared `ProviderTransport` + purpose-filtered `VerificationKeySet`, single-flight JWKS cache, webhook replay binding |
...
| [plans/2026-08-05-index_change_specs/plan.md](plans/2026-08-05-index_change_specs/plan.md) | Draft | branch `spec/index-2026-08-05-change-specs` / PR #28 index-only documentation intent |
